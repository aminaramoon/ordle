...
class ActionCard extends StatelessWidget {
  const ActionCard({Key? key, required this.icon, this.callback})
      : super(key: key);
...
class LetterRow extends StatelessWidget {
  const LetterRow(
      {Key? key, required this.firstIndex, required this.secondIndex})
      : super(key: key);
...
class NewKeyboard extends StatelessWidget {
  const NewKeyboard({Key? key, required this.locale}) : super(key: key);
